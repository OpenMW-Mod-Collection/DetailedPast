...
this.azura = {
    id = "azura",
    name = "Azura",
    --Shame I don't know how to add bonuses only during Dawn and Dusk :(
    description = (
...
this.lorkhan = {
    id = "lorkhan",
    name = "Lorkhan",
    --I really run out of ideas here, sorry :( Actually I kinda like it, you get bonus to magicka because of proximity to Heart of Lorkhan + it's kinda funny how Alduin (Destroyer) and Lorkhan (Creator) have the same bonus.
    description = (
